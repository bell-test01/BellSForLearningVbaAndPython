...
import fws_apps.tkinter.fws_spec_generator.contents.fws_contents as fws_contents


class FwsSpecGeneratorService:
    """
    Summary:
    ...
    def generate_html_spec(
        ...
        Args:
            self: FwsSpecGeneratorService - FwsSpecGeneratorServiceクラスのインスタンス自身。
    ...
    def _build_html(self, modules: typing.List[fws_spec_entities.FwsModuleInfo]) -> str:
        """
        Summary:
    ...
    def _build_module_user_guide(self, m: fws_spec_entities.FwsModuleInfo, m_idx: int) -> str:
        """
        Summary:
    ...
    def _build_module_content(self, m: fws_spec_entities.FwsModuleInfo, m_id: str, m_idx: int) -> str:
        """
        Summary:
    ...
    def _build_function_content(self, f: fws_spec_entities.FwsFunctionInfo, f_id: str, is_method: bool) -> str:
        """
        Summary:
        ...
        html += f'<tr><td class="type-col font-code">{f.returns_type}</td><td>{html_module.escape(f.returns_desc)}</td></tr>'
        html += '</tbody></table>'
